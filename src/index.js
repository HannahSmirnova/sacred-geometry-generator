...
function generatePractice(event) {
  ...
  or arranging them. Make sure to follow user instructions and bring effective, applicable and doable practice. Format the response with a bold title at the top
   ...
   format them as a bullet-point list or numbered list, clearly separated from the paragraph. Ensure the formatting is clean and easy to read. 
   At the end, suggest a crystal that enhances the intended effect of the practice.`;
  let context =
